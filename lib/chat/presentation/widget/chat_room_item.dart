import 'package:facebook_clone/providers/user_info_by_id_provider.dart';
import 'package:facebook_clone/utils/extensions.dart';
...
class ChatRoomItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final userInfo = ref.watch(userInfoByIdProvider(userId));
